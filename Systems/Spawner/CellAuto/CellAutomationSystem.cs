			...
			e.AddMatPara( null, new(){
				{
					...
					"FireColPanel", ( "FirePanel.png", new TexParam( false, true ) )
				},{
					"StoneColPanel", ( "StonePanel.png", new TexParam( false, true ) )
				},{
					"SandColPanel", ( "SandPanel.png", new TexParam( false, true ) )
				},{
					"OilColPanel", ( "OilPanel.png", new TexParam( false, true ) )
				},{
					"AcidColPanel", ( "AcidPanel.png", new TexParam( false, true ) )
				}
			} );
		}
	}
