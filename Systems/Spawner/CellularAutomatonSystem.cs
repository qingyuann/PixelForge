...
public class CellularAutomatonSystem : IInitializeSystem, IExecuteSystem {
	...
	public void Initialize() {
		Debug.Log( "CellularAutomatonSystem" );
		...
		_cellularAutomatonGroup.OnEntityAdded += ( group, entity, index, component ) => {
	...
	public void Execute() {
		foreach( var e in _cellularAutomatonGroup.GetEntities() ) {
			...
			if( e.hasMatSingleRenderer ) {
				...
				e.matSingleRenderer.Renderer.Textures["MainTex"].UpdateImageContent( data, 256, 256 );
			}
		}
	}
}