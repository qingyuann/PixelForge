...
public class HierarchySystem : IInitializeSystem
{
    ...
    void InitEntity()
    {
        ...
        camera.AddLightShadowLight(true, new[] { 0 }, 0, 0.5f, 2f, 2f,
        ...
        quad1.AddComponentPosition(0.25f, 1f, 1);
        ...
        quad2.AddComponentPosition( -1.5f, -0.3f, 0 );
        ...
        quad3.AddComponentPosition( 0.8f, 0, 0 );
        ...
        quad4.AddComponentPosition( 2f, 0.5f, -0f );
        ...
        quad5.AddComponentPosition( 1.7f, -0.7f, 0 );
